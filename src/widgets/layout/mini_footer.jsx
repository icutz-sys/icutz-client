...
import Logo from '../../assets/svgs/logo_light.svg';
function MiniFooter() {
  return (
    <footer className="relative overflow-hidden bg-neutral-900">
      ...
      <div className="relative z-10">
        <div className="w-full max-w-7xl px-4 xl:px-0 py-7 mx-auto">
          <div className="inline-flex items-center">
            <img src={Logo} alt="logo" className="w-40" />

            <div className="border-s border-neutral-700 ps-5 ms-5">
              <p className="text-sm text-neutral-400">2024 ICutz Co.</p>
            </div>
          <Link to="/home" className='ml-10 text-sm text-neutral-400 hover:underline'>Home</Link>
          </div>
        </div>
      </div>
    </footer>
